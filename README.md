...
The distance file is an arduino file which calculates the distnace using ultrasonic sound (the electical device)/ we can implement that for the use of the user interface application
